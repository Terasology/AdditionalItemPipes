...
/**
 * This Component differentiates the Sorter from other blocks. It contains the Sorter's filter and index od the side to
 * which items not listed in the filter will be put.
 */
